...
export function newMemberEmail(member: Member, password: string): string {
...
And in case you don't have it already here is our discord: https://discord.gg/JRQECaeYKN
