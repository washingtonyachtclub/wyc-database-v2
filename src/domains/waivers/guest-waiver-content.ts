import {
  getWaiverTextSegments,
  waiverParagraph,
  type WaiverParagraph,
  type WaiverTextSegment,
} from './waiver-content'

export const guestWaiverVersion = 'guest-participant-agreement-v2'
export type GuestWaiverParagraph = WaiverParagraph
export type GuestWaiverTextSegment = WaiverTextSegment
export const getGuestWaiverTextSegments = getWaiverTextSegments
